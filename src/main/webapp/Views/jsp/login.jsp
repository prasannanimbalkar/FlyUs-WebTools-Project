...
<body>
	...
	<div class="login-container">
		<form action="login.htm" method="post" class="form-login">
			...
			<ul class="login-nav">
				<li class="login-nav__item active"><a href="#">Sign In</a>
			</ul>
			<label for="login-input-user" class="login__label"> Username</label> 
			<input id="login-input-user" class="login__input" type="text" name="username" size="30" required /> 
		   <label for="login-input-password" class="login__label"> Password </label> 
		   <input id="login-input-password" class="login__input" type="password" name="password" size="30" required /> 
		   <input class="login__submit"type="submit" value="Login" />
		   <br>
		   <p><a href="index.htm" style="color: white; padding: 20px; text-decoration: none;"> Go Back to Main Page</a></p>
		</form>
